...
const reasons = [
  {
    ...
    text: "Проект, монтаж и сервисное обслуживание в одной команде. Без поиска подрядчиков и перекладывания ответственности.",
  },
  {
    title: "На рынке с 1997 года",
    text: "Учитываем слепые зоны и реальные сценарии бизнеса, чтобы камеры показывали важное, а не случайные участки.",
  },
  {
